...
from .views import ItemListView, ItemDetailView, ItemDeleteView,ItemCreateView, ItemUpdateView, CommentView, add_to_cart, view_cart
from . import views
...
urlpatterns = [
    ...
    # path('update-cart/<int:cart_item_id>/',CommentView.as_view(), name="update_cart"),
